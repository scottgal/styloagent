...
// Suppress CA analyzer warnings on vendored public surface that the commit-graph rendering control depends on.
// CA1002: List<T> in public APIs — preserved to match SourceGit's public contract.
// CA1051: visible instance fields (Link/Dot) — preserved to match SourceGit's public contract.
// CA1805: explicit default initializers — preserved for clarity in vendored code.
#pragma warning disable CA1002, CA1051, CA1805
...
namespace Styloagent.Git.Vendored.Models
{
    ...
    public class CommitGraph
    {
        ...
        private class PathHelper
        {
            ...
            /// <summary>
            ///     A path that has commit in this row and ends.
            /// </summary>
            ...
            /// <summary>
            ///     End the current path and create a new highlighted path from the end.
            /// </summary>
...
#pragma warning restore CA1002, CA1051, CA1805
